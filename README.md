...
You just have to download the project, install the packages presented below and launch your bot. If there is a problem with your bot, do not hesitate to join my [Discord Server](https://discord.gg/EjGDhhyEaC) and tell me about the problem so that I can help you the best.
To change prefix goto: 
```
\events\message (line 6)
```
To Change your token:
```
\storage\config.json (line 2)
```
## Packages to install
